...
const Speech = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "Speech");
	return (
		<>
			...
			<TextImageStrip
				...
				reverse={true}
			/>
			<Title title="How it's made" size="h2" alignment="center" padding="top-padding" />
			<Title
				...
				padding=""
			/>
			<FullWidthImage project={projectInfo.name} image="Exploded view.jpg" padding="bottom-padding" />
			...
			<FullWidthImage project={projectInfo.name} image="ImageGallery/Render 2.jpg" padding="bottom-padding" />
		</>
	);
};
