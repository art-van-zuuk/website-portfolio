...
const SlideToLight = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "Slide to Light");
	return (
		<>
			<ProjectBanner projectList={projectList} project="Slide to Light" />
			...
			<TextImageStrip
				...
				reverse={true}
			/>
			<Title title="How to play" size="h2" alignment="center" padding="top-padding" />
			<FullWidthImage project={projectInfo.name} image="HowToPlay.png" padding="bottom-padding" />
			<TextImageStrip
