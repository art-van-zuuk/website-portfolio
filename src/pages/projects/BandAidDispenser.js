...
const BandAidDispenser = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "Band Aid Dispenser");
	...
	return (
		<>
			...
			<Title title="Make it as intuitive as possible" size="h2" alignment="center" padding="top-padding" />
			<Title
			...
			/>
			<FullWidthImage project={projectInfo.name} image="Action elements.jpg" padding="bottom-padding" />
			<FullWidthImage project={projectInfo.name} image="Product render.jpg" padding="top-padding" />
			<FullWidthImage project={projectInfo.name} image="Render close-up.png" padding="top-bottom-padding" />
		</>
	);
};
