...
const Chessboard = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "Chessboard");

	return (
		<>
			<Title title={projectInfo.name} size="h1" alignment="start" padding="top-padding" />
			<Title title={projectInfo.description} size="h4" alignment="start" padding="" />
			<Title title={projectInfo.explanation} size="p" alignment="start" padding="" />
