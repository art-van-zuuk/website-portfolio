...
const BraunParch = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "Braun Parch");
	...
	return (
		<>
			...
			<SkillImages skills={["photoshop", "illustrator", "solidworks", "3dprinting"]} />
			<TextImageStrip
				title="Food waste..."
			...
			<TextImageStrip
				...
				reverse={true}
			/>
			<Title title="Drying food with the power of vacuum..." size="h2" alignment="center" padding="top-padding" />
			<Title
				...
				padding=""
			/>
			<FullWidthImage project={projectInfo.name} image="step_explaination.png" padding="top-bottom-padding" />

			<Title title="A better design in many ways" size="h2" alignment="center" padding="top-padding" />
			<CardColumns
				cardInfo={[
					{
						title: "Quick",
			...
			/>
			<FullWidthImage project={projectInfo.name} image="sketches.png" padding="top-bottom-padding" />
			<TextImageStrip
				...
				reverse={true}
			/>
			<FullWidthImage project={projectInfo.name} image="inspiration.jpg" padding="top-padding" />
			<Title title="Images by: Braun" size="p" alignment="start" padding="bottom-padding" />
			<TextImageStrip
