...
const HANA = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "HANA");
	...
	return (
		<>
			...
			<SkillImages skills={["photoshop", "indesign", "solidworks", "3dprinting", "userresearch"]} />
			...
			<TextColumns
				...
				marginHeight=""
			/>
			<Title title="Problems with today's navigation" size="h2" alignment="center" padding="top-padding" />
			<CardColumns
				cardInfo={[
					{
						title: "Inaccuracy",
			...
			<Title title="Navigation on the tip of your finger" size="h4" alignment="center" padding="" />
			<FullWidthImage project={projectInfo.name} image="HANAScenario.png" padding="bottom-padding" />
			<TextImageStrip
				title="A tactile dot"
			...
			<TextVideoStrip
				...
				reverse={true}
			/>
			<Title title="User testing" size="h2" alignment="center" padding="top-padding" />
			<Title
