...
const MARCHVII = () => {
	...
	var projectInfo = GetProjectInfo(projectList, "MARCH VII");
	...
	return (
		<>
			...
			<TextImageStrip
				...
				rounded={true}
			/>
			<Title title="A unique design every year" size="h2" alignment="start" padding="top-padding" />
			<Title
			...
			<FullWidthImage project={projectInfo.name} image="Drawings.jpg" padding="" />

			<FullWidthImage project={projectInfo.name} image="Concepts.jpg" padding="" />
			<Title
			...
			<Title title="Main focus points" size="h2" alignment="center" padding="top-padding" />
			<CardColumns
				cardInfo={[
					{
