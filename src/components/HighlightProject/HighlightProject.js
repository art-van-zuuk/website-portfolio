...
function HighlightProject(props) {
    ...
    return (
        <div className="App" >
            <div className="highlight-div" style={{backgroundColor: selectedProject.backgroundColor}}>
                <Container className="site-width">
                    <Row className="align-items-center justify-content-center gx-5 gy-5">
                        ...
                        <Col className="col-md-6 col-12">
                            ...
                            <p> With this assigment, Braun aimed to make a change in the increasing problem of food waste. I found that a big part of this waste happens at the consumption and espesially at the conservation of food. </p>
                            <p>  </p>
                            <b> {selectedProject.type} in {selectedProject.year} </b>
                            <p>  </p>
