...
function ScrollDownTransparency() {
	...
	const changeTransparency = () => {
		if (window.scrollY < windowSize.innerHeight) {
			setTransparency(1 - (window.scrollY / windowSize.innerHeight) * (1 - minTransparency));
		}
	};
						...
						<Row className="align-items-center justify-content-center">
							<Col className="col-12 col-md-8" style={{ width: "500px", maxWidth: "90vw" }}>
								<h2 className="text-white text-center">
									{title === "" || title === undefined ? "A portfolio by Art" : title}
								</h2>
								<p className="text-white text-center">
									{text === "" || text === undefined
										? "This is my portfolio website. Here I showcase all of the project that I am proud of. A few projects are highlighted and I would love for you to see them. But if you are interested to see more, feel free to look around."
										: text}
								</p>
							</Col>
						</Row>
