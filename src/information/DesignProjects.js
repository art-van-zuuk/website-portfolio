...
designProjectList.push({
	...
	contribution: "Creating initial concept, creating final design, visualization and technology research",
	type: "Bachelor Project",
	year: "2019",
	team: "Group project",
	textColor: "white",
...
designProjectList.push({
	...
	contribution: "User and durability testing, designing PCB, visualization and detailing",
	type: "Master Project",
	year: "2021",
	team: "Group Project",
	textColor: "white",
...
designProjectList.push({
	...
	contribution:
		"Designed, tested and build the leg covers, add magnet based fastening mechanism and improved cable management.",
	type: "Project MARCH",
	year: "2022",
	team: "Team Project",
...
designProjectList.push({
	...
	explanation:
		"For a lighting design course, we were challenged to conceptualize a Barbapapa lamp, a lamp that can dynamically change in any way or form. We created a design that can transform to fit to the needs of a visitor of the DOK Library in Delft, by integrating scene recognition and a transformable lampshade design, that fits the playful nature of the place.",
	contribution: "Design and build lamp mechanism, and program and integrate scene recognition algorithm",
	type: "Master Project",
	year: "2023",
	team: "Team Project",
	textColor: "white",
...
designProjectList.push({
	...
	contribution:
		"Responsible for the UX/UI and coding the layout, elements and navigation throughout the full application.",
	type: "Work Project",
	year: "2023",
	team: "Team Project",
...
designProjectList.push({
	...
	explanation:
		"Many people experience saddle sores during cycling. Therefore, a novel variable geometry bicycle saddle has been proposed that aims to create a better pressure distribution. The outcome is based on a lot of tests and (user) research by the use of prototypes.",
